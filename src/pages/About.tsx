    ...
    <main className="pt-16 md:pt-20">
      ...
      <section className="section-spacing bg-secondary/20">
        <div className="container-main text-center">
          <h1 className="font-display text-4xl md:text-5xl font-semibold text-foreground mb-6">About Inner Springs Africa</h1>
          <p className="font-body text-muted-foreground max-w-3xl mx-auto text-lg text-balance">
      ...
      <section className="section-spacing bg-background">
        <div className="container-main grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="card-surface bg-card p-8 rounded-2xl">
            <p className="font-display text-sm font-semibold text-accent uppercase tracking-wider mb-3">Our Vision</p>
            <p className="font-body text-foreground text-balance">
          ...
          <div className="card-surface bg-card p-8 rounded-2xl">
            <p className="font-display text-sm font-semibold text-accent uppercase tracking-wider mb-3">Our Mission</p>
            <p className="font-body text-foreground text-balance">
      ...
      <section className="section-spacing bg-card">
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <img src={aboutMission} alt="Inner Springs team collaborating" className="image-frame w-full rounded-2xl" />
          <div>
            <h2 className="font-display text-3xl font-semibold text-foreground mb-6">Our Story</h2>
      ...
      <section className="section-spacing bg-background">
        <div className="container-main">
          <h2 className="font-display text-3xl font-semibold text-foreground text-center mb-16">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map(v => (
              <div key={v.title} className="card-surface bg-card p-8 rounded-2xl gold-top-border">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-5">
                  <v.icon className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-display text-xl font-semibold text-foreground mb-3">{v.title}</h3>
                <p className="font-body text-muted-foreground text-sm text-balance">{v.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-spacing bg-card">
        <div className="container-main text-center">
          <h2 className="font-display text-3xl font-semibold text-foreground mb-6">Our Team</h2>
          <p className="font-body text-muted-foreground max-w-2xl mx-auto mb-10 text-balance">
          ...
          <img src={aboutTeam} alt="Inner Springs Africa professional team" className="image-frame w-full max-w-4xl mx-auto rounded-2xl" />
        </div>
      </section>
